...
export default function Login({navigation}) {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={{ marginTop: 10}} onPress={()=> navigation.navigate('CadastroProfessor')}>
        <Text style={{textAlign: 'center'}}>Não tem uma conta?<Text style={{ color:'#007AFF', fontWeight:'bold'}}> Cadastre-se</Text></Text>
      </TouchableOpacity>

      <TouchableOpacity style={{ marginTop: 10}} onPress={()=> navigation.navigate('CadastroAluno')}>
        <Text style={{textAlign: 'center',  color:'#007AFF', fontWeight:'bold'}}>Cadastrar Aluno</Text>
      </TouchableOpacity>
