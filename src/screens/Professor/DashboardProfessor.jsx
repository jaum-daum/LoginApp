        ...
        <View style={styles.menuContainer}>
          ...
          >
            ...
            <View style={styles.menuTextContainer}>
              ...
              <Text style={styles.menuDescription}>Adicione um aluno ao seu sistema</Text>
            </View>
          ...
          >
            ...
            <View style={styles.menuTextContainer}>
              ...
              <Text style={styles.menuDescription}>Visualize alunos e monte fichas</Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color="#C7C7CC" />
          </TouchableOpacity>
        </View>
...
const styles = StyleSheet.create({
  ...
  statNumber: { fontSize: 24, fontWeight: 'bold', color: '#1C1C1E', marginTop: 10 },
